...
\begin{enumerate}
    \item \textbf{基于公开数据集的初步验证研究}：利用公开的多芯光纤散斑数据集\citep{sun2023_figshare_dataset1,sun2023_figshare_dataset2}，复现和验证了深度学习方法在散斑图像重建中的可行性。通过系统分析网络架构、损失函数、训练参数等关键因素对重建性能的影响，建立了散斑图像重建的基本流程和性能评价标准，为后续自建系统的研究奠定了基础。
